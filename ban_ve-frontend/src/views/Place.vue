    ...
    <v-row class="mt-4">
      <v-col cols="12" md="8">
        <div style="position: relative">
          <HUMGCarousels :items="place.images" />
        </div>
      </v-col>
      <v-col cols="12" md="4">
        <HUMGTitle class="text-h4">{{ place.name }}</HUMGTitle>
    ...
    <v-container class="mt-6">
      <v-row>
        <v-col cols="12" md="8">
          ...
          <HUMGTimeline :timeline="place.reviews" />
        </v-col>
      </v-row>
    </v-container>
  </div>
...
<script>
  ...
  import HUMGQuickFacts from '@/components/Places/Card/quickFacts.vue';
